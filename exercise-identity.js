...
export function ensureExerciseIdentityState(state){
  ...
  for(const u of state.user_exercises){u.archived=u.archived===true;u.createdLanguage=u.createdLanguage==='lv'?'lv':'en';u.trackingMode=u.trackingMode||trackingModeFor(u.equipment);u.candidateCanonicalExerciseId=u.candidateCanonicalExerciseId||null;}
  return state;
}
