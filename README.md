...
**Manual Supabase action is required before using cloud erase or Delete account.** Follow `DATABASE_UPDATE_INSTRUCTIONS_1.5.1_1.6.1.md` and run `supabase/SUPABASE_ACCOUNT_DATA_CONTROL_UPDATE_1.5.1_1.6.1.sql` once. This is applied after the previous social + training-sync migrations.
